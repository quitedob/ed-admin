<template>
  <el-upload id="file-upload" ref="upload" :before-upload="beforeAvatarUpload" :http-request="onUpload" :show-file-list="false" :multiple="true">
...
<script setup>
  ...
  onMounted(() => {
    console.log(`打开文件: ${location.pathname} -> components/Upload/File/index.vue`);
  });
