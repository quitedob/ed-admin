<template>
  <div id="editor-container" style="border: 1px solid #ccc; margin-top: 10px; width: 100%">
    <toolbar id="editor-toolbar" :editor="editorRef" :default-config="toolbarConfig" mode="simple" style="border-bottom: 1px solid #ccc" />
    <editor id="editor-content" :default-config="editorConfig" :model-value="props.modelValue" style="height: 300px" @on-change="handleChange" @on-created="handleCreated" />
  </div>
...
<script setup>
  ...
  onMounted(() => {
    console.log(`打开文件: ${location.pathname} -> components/Editor/index.vue`);
  });
