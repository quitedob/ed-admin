...
export const useUserStore = defineStore({
  ...
  state: () => ({
    ...
    menuList: [],
    permissionList: [],
    authorizedClassIds: [], // 被授权管理的班级ID列表
    authorizedSubjects: [], // 被授权管理的学科列表
  ...
  getters: {
    ...
    getAuthorizedClassIds(state) {
      return state.authorizedClassIds
    },
    getAuthorizedSubjects(state) {
      return state.authorizedSubjects
    },
  ...
  actions: {
    // 登录操作
    login(data) {
      this.mobile = data.mobile || data.username
      ...
      this.authorizedClassIds = data.authorizedClassIds || []
      this.authorizedSubjects = data.authorizedSubjects || []
    ...
    mockLogin() {
      ...
      this.routerList = [
        ...
        { id: 29, path: '/class/management', menuName: '班级管理', component: '/class/management/index.vue' },
        { id: 29, path: '/class/authorization', menuName: '班级授权', component: '/class/authorization/index.vue' },
        { id: 30, path: '/system/role', menuName: '角色管理', component: '/system/role/index.vue' },
        { id: 31, path: '/system/settings', menuName: '系统设置', component: '/system/settings/index.vue' }
      ]
      // 模拟菜单列表
      this.menuList = [
