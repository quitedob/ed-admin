...
export const courseApi = {
  ...
  // 课程复制
  courseCopy: (data) => {
    return postRequest('/course/admin/course/copy', data)
  },

  // 课程详情（增强版）
  courseDetail: (data) => {
    return getRequest('/course/admin/course/detail?id=' + data.id)
  },

  // 课程分析数据
  courseAnalytics: (data) => {
    return postRequest('/course/admin/course/analytics', data)
  },

  // 课程统计数据
  courseStats: (data) => {
    return postRequest('/course/admin/course/stats', data)
  },
