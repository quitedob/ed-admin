  ...
  <div class="homework-list-container">
    ...
    <div class="top-bar">
      ...
      <div class="action-buttons">
        <el-button v-if="hasPermission('homework:create')" type="primary" @click="handleCreate">
        ...
        >
          <el-card class="homework-card" shadow="hover">
            ...
            <div class="homework-info">
              <div class="info-item">
                ...
                <el-button
                  ...
                  type="primary"
                  size="small"
                  @click="copyHomeworkId(homework.id)"
                  title="复制作业ID"
                >
            ...
            <div class="homework-actions card-actions">
              ...
              <el-button v-if="hasPermission('homework:delete')" link type="danger" @click="handleDelete(homework)">
...
// 权限控制
const { hasPermission, hasGlobalView, authorizedSubjects, filterAuthorizedHomeworks } = usePermission()
...
const filteredHomeworks = computed(() => {
  // 首先根据用户权限过滤学科（老师只能看到被授权学科的作业）
  let result = filterAuthorizedHomeworks(homeworks.value)
  ...
  homeworks.value = [
    {
      ...
      courseId: 'course_001',
      courseName: '前端开发基础',
      subject: 'cpp_programming', // 学科：C++编程
      title: '第一章作业',
    ...
    },
    {
      ...
      courseId: 'course_001',
      courseName: '前端开发基础',
      subject: 'english', // 学科：英语（老师没有此学科权限，不会显示）
      title: '第三章作业',
      description: '第三章综合练习',
      type: 'practice',
      difficulty: 'hard',
...
const copyHomeworkId = async (homeworkId) => {
  try {
    await navigator.clipboard.writeText(homeworkId)
    ElMessage.success('作业ID已复制到剪贴板')
  } catch (err) {
    // 降级方案：使用传统的复制方法
    try {
      const textArea = document.createElement('textarea')
      textArea.value = homeworkId
