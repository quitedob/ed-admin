...
<script setup>
  ...
  // 移除验证：设置模拟数据
  page.list = [
    { id: 1, mobile: 'admin', realName: '管理员', roleNameList: ['管理员'], remark: '系统管理员', statusId: 1 },
    { id: 2, mobile: 'user1', realName: '用户1', roleNameList: ['普通用户'], remark: '测试用户', statusId: 1 },
    { id: 3, mobile: 'user2', realName: '用户2', roleNameList: ['普通用户'], remark: '测试用户', statusId: 0 }
  ]
  page.totalCount = page.list.length
  page.loading = false

  onMounted(() => {
    console.log(`打开文件: ${location.pathname} -> views/system/user/index.vue`);
  });
