<template>
  <el-dialog :append-to-body="true" :model-value="visible" title="菜单设置" width="600px" center align-center :destroy-on-close="true" @close="onClose">
...
<script setup>
  ...
  onMounted(() => {
    console.log(`打开文件: ${location.pathname} -> views/system/role/MenuSet.vue`);
  });
