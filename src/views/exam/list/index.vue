  ...
  <div class="exam-list-container">
    ...
    <div class="top-bar">
      ...
      <div class="action-buttons">
        <el-button v-if="hasPermission('exam:create')" type="primary" @click="handleCreate">
        ...
        >
          <el-card class="exam-card" shadow="hover">
            ...
            <div class="exam-actions card-actions">
              ...
              <el-button v-if="hasPermission('exam:grade')" link type="info" @click="handleGrade(exam)">
                <el-icon><DocumentChecked /></el-icon>
                批改
              </el-button>
              <el-button v-if="hasPermission('exam:delete')" link type="danger" @click="handleDelete(exam)">
...
// 权限控制
const { hasPermission, hasGlobalView, filterAuthorizedExams } = usePermission()
...
const filteredExams = computed(() => {
  // 首先根据用户权限过滤学科（老师只能看到被授权学科的考试）
  let result = filterAuthorizedExams(exams.value)
